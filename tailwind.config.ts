...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        card: "0 4px 12px hsl(220 30% 15% / 0.10), 0 2px 6px hsl(220 30% 15% / 0.06)",
        primary: "0 8px 24px hsl(234 74% 55% / 0.25)",
        accent: "0 8px 24px hsl(35 98% 52% / 0.25)",
        lg: "0 10px 30px hsl(220 30% 15% / 0.12)",
      },
      keyframes: {
        ...
        "pulse-glow": { "0%, 100%": { boxShadow: "0 0 0 0 hsl(234 74% 55% / 0.4)" }, "50%": { boxShadow: "0 0 0 12px hsl(234 74% 55% / 0)" } },
      },
      animation: {
