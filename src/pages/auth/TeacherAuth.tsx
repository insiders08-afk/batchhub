...
export default function TeacherAuth() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    requests.push({ ...form, role: "teacher", status: "pending", submittedAt: new Date().toISOString() });
    localStorage.setItem("lamba_pending_requests", JSON.stringify(requests));
    setSubmitted(true);
  };

  if (submitted) {
    return <PendingApprovalScreen role="teacher" name={form.name} instituteId={form.instituteId} />;
  }
        ...
        <div className="w-full max-w-md">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <div className="text-center mb-8">
              ...
              <h1 className="text-2xl font-display font-bold mb-1">Join as Teacher</h1>
              <p className="text-muted-foreground text-sm">Submit your details — your admin will verify and approve your access.</p>
            </div>
            ...
            <Card className="p-6 shadow-card border-border/50">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <p className="text-xs text-muted-foreground">Your unique teacher ID assigned by the institute.</p>
                </div>
                ...
                <Button type="submit" className="w-full bg-gradient-to-r from-success to-emerald-400 text-white border-0 hover:opacity-90 h-11 font-semibold">
    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4">
      ...
      >
        ...
        <p className="text-muted-foreground mb-4">
          ...
          <span className="font-semibold text-success capitalize">{role}</span> at institute{" "}
        ...
        <p className="text-xs text-muted-foreground mb-4">
          Your admin will review and approve within 24 hours. You'll be notified on your registered email/phone.
        </p>
